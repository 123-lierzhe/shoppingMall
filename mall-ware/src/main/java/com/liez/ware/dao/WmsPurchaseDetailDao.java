...
public interface WmsPurchaseDetailDao {
	 ...
	 * @return 对象列表
	 */
	List<WmsPurchaseDetail> queryAllByLimit(@Param("offset") int offset, @Param("limit") int limit);
	 ...
	 * @return 对象列表
	 */
	List<WmsPurchaseDetail> queryAll(WmsPurchaseDetail wmsPurchaseDetail);
